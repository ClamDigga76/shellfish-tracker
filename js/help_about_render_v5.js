...
export function renderHelpViewHTML({ renderPageHeader, escapeHtml, displayBuildVersion, schemaVersion, isStandalone, hasSWController, installModel }) {
  return `
    ...
    <div class="helpHubRows helpHubRowsDirect" role="list" aria-label="Help sections">
        ...
        <details class="helpHubRowWrap" data-help-accordion data-help-key="reports" role="listitem"><summary class="helpHubRow" id="help_jump_reports"><span class="helpHubRowIcon">📈</span><span class="helpHubRowBody"><span class="helpHubRowLabel">Insights</span><span class="helpHubRowDesc">Full season intelligence and deeper trends</span></span><span class="helpHubRowChevron" aria-hidden="true">⌄</span></summary><div class="helpHubRowContent muted helpSectionLead"><div><b>Use it for:</b> deeper season trends by date range, dealer, area, and month.</div><ol style="margin:8px 0 0 18px"><li>Insights improve as your saved trip history grows.</li><li>Pick a date window.</li><li>Add optional dealer/area filters, then switch between charts and table views.</li></ol></div></details>
        <details class="helpHubRowWrap" data-help-accordion data-help-key="newtrip" role="listitem"><summary class="helpHubRow" id="help_jump_newtrip"><span class="helpHubRowIcon">📝</span><span class="helpHubRowBody"><span class="helpHubRowLabel">New Trip</span><span class="helpHubRowDesc">Log pounds, pay, dealer, and area</span></span><span class="helpHubRowChevron" aria-hidden="true">⌄</span></summary><div class="helpHubRowContent muted helpSectionLead"><div><b>Use it for:</b> logging one harvest trip at a time.</div><ol style="margin:8px 0 0 18px"><li>Set <b>Date</b>.</li><li>Enter <b>Pounds</b> and <b>Amount</b>.</li><li>Choose <b>Dealer</b> and <b>Area</b>.</li><li>Tap <b>Save Trip</b>.</li></ol><div style="margin-top:8px"><b>Plain-language note:</b> <b>Pounds</b> is your harvest amount. <b>Amount paid</b> and <b>Price per pound</b> show what the dealer paid for that trip.</div><div style="margin-top:8px"><b>Tip:</b> chips fill in as you save more trips. Use list pickers first if chips are empty.</div></div></details>
