...
export const HOME_SHARED_CHART_DEFINITIONS = Object.freeze({
  ...
  pplByDealer: Object.freeze({
    ...
    explanation: "Shows average price per pound by dealer (total pay ÷ total pounds), ranked for groups with at least 2 trips and 150 lbs in the selected date range."
  }),
  pplByArea: Object.freeze({
    ...
    explanation: "Shows average price per pound by area (total pay ÷ total pounds), ranked for groups with at least 2 trips and 150 lbs in the selected date range."
  }),
  ...
  amountPerTripByMonth: Object.freeze({
    ...
    explanation: "Shows average pay per trip by month in the selected date range; the current month is labeled so far when still building."
  }),
