...
import { uid, toCSV, downloadText, formatMoney, formatDateMDY, computePPL, to2, parseMDYToISO, parseNum, parseMoney, likelyDuplicate, normalizeKey, escapeHtml } from "./utils_0080.js";

const VERSION = "ESM-0080";
// ---- Toasts ----
let toastTimer = null;
...
function getDebugInfo(){
  ...
  let lastErr = "";
  let lastErrAt = "";
  try{ lastErr = localStorage.getItem("SHELLFISH_LAST_ERROR")||""; }catch{}
