...
import { uid, toCSV, downloadText, formatMoney, formatDateMDY, computePPL, to2, parseMDYToISO, parseNum, parseMoney, likelyDuplicate, normalizeKey, escapeHtml } from "./utils_007I.js";
...
function renderEditTrip(){
  ...
  app.innerHTML = `
    <div class="card">
      ...
      <div class="hint">Tap Save Changes when finished. Delete removes the trip from this device.</div>
    </div>
...
function renderAbout(){
  ...
  document.getElementById("backSettings").onclick = ()=>{
    const dest = state.navReturn || "settings";
    state.navReturn = "";
    state.view = dest;
    state.lastAction = "nav:back";
    saveState();
