            ...
            <div class="tripsFiltersSection tripsMoreFiltersSection">
              ...
              ${moreFiltersExpanded ? `
                <div class="tripsMoreFiltersFields">
                  ...
                  <div class="tripsMoreFiltersGroup"><div class="tripsFiltersSectionLabel">Price/lb</div><div class="tripsFiltersPairedFields"><input id="flt_min_ppl" class="select" type="number" step="any" value="${escapeHtml(String(tf.minPpl || ""))}" placeholder="Min price/lb"><input id="flt_max_ppl" class="select" type="number" step="any" value="${escapeHtml(String(tf.maxPpl || ""))}" placeholder="Max price/lb"></div></div>
                </div>
              ` : ""}
            </div>
