        ...
        <section class="homeSection homeOverviewCard">
          ...
          <div class="homeOverviewGrid">
            ...
            <div class="homeOverviewStat">
              ...
              <div class="reportsHeroValue homeOverviewDealerValue">${escapeHtml(isSeasonPreviewMode ? (strongestDealer ? "Full Insights — Coming Soon" : "—") : (strongestDealer?.dealer || "—"))}</div>
              <div class="reportsHeroMeta">${isSeasonPreviewMode ? (strongestDealer ? "Dealer trends are coming with Full Insights." : "No trips in range") : topDealerSupport}</div>
            </div>
            <div class="homeOverviewStat">
              <div class="reportsHeroLabel">STRONGEST AREA</div>
              <div class="reportsHeroValue">${escapeHtml(isSeasonPreviewMode ? (strongestArea ? "Full Insights — Coming Soon" : "—") : (strongestArea?.area || "—"))}</div>
