        ...
        <section class="homeSection homeOverviewCard">
          ...
          <div class="homeOverviewGrid">
            ...
            <div class="homeOverviewStat">
              ...
              <div class="reportsHeroMeta">${isSeasonPreviewMode ? (strongestArea ? "Coming Soon" : "No trips in range") : (strongestArea ? `<span class="lbsBlue">${formatHomePounds(strongestArea.pounds, { maximumFractionDigits: 1 })}</span> · <span class="tripsMetric">${Math.round(Number(strongestArea.trips) || 0)} trips</span>` : "No trips in range")}</div>
            </div>
          </div>
        </section>
